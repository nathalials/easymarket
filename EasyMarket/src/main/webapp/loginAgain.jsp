            ...
            <div class="login">
                <form name="form_validarLogin" action="ValidarLogin" method="post">
                    <p class="login">
                        ...
                        <label for="login" class="dados">Login</label> <input type="text" id="loginid"
                                                                              placeholder="Login" required="required" name="login" class="campo"/>
                    </p>

                    <p class="senha">
                        <label for="senha" class="dados">Senha</label> <input type="password" id="senhaid"
                                                                              placeholder="Senha" name="senha" class="campo"/>
                    </p><br>
                    <p class="submit">
